...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>
          Sağlık Turizmi Gündemi - Türkiye'nin İlk ve Tek Sağlık Turizmi
          Programı
        </title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta
          name="description"
          content="Sağlık Turizmi Gündemi, Türkiye'nin ilk ve tek sağlık turizmi programı, en güncel sağlık haberleri ve doktor bilgileri ile sizlerle."
        />
        <meta
          name="keywords"
          content="sağlık turizmi, sağlık haberleri, Türkiye sağlık turizmi, doktorlar, sağlık rehberi"
        />

        {/* Open Graph Meta Tags */}
        <meta
          property="og:title"
          content="Sağlık Turizmi Gündemi - Türkiye'nin İlk ve Tek Sağlık Turizmi Programı"
        />
        <meta
      ...
      <div
        className="min-h-screen overflow-hidden pb-10 relative"
        style={{
          backgroundImage: `linear-gradient(to bottom, #1580b6, #157fb9, #00a658, #02a35f)`,
        }}
      >
        {/* Ege TV Logo */}
        <div className="absolute right-[4rem] top-6 md:right-[13rem] md:top-10">
          <Image
            src="/images/egetv.png"
            alt="Ege TV Logo"
            width={90}
            height={90}
            className="md:w-[150px] md:h-[145px]"
          />
        </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-12 left-0">
                <div className="flex items-center gap-3">
                  <a
                    href="https://www.facebook.com/saglikturizmir"
                    target="_blank"
                  ...
                  <a
                    href="https://www.linkedin.com/in/sa%C4%9Fl%C4%B1kturizmir/"
                    target="_blank"
                    className="text-white/60 hover:text-white transition-colors duration-300"
                  >
                    <Linkedin size={14} />
                  ...
                  <a
                    href="https://www.youtube.com/@saglikturizmir"
                    target="_blank"
                    className="text-white/60 hover:text-white transition-colors duration-300"
                  >
                    <Youtube size={14} />
                  ...
                  <a
                    href="https://www.instagram.com/saglikturizmir/"
                    target="_blank"
                    className="text-white/60 hover:text-white transition-colors duration-300"
                  >
                    <Instagram size={14} />
        ...
        <div className="flex flex-col md:flex-row items-center md:items-end justify-center gap-[2rem] text-center mt-[1rem]">
          ...
          <div className="flex flex-col items-center justify-center gap-[40px] md:gap-[100px]">
            <div className="relative">
              ...
              <span
                className={`
                absolute -top-6 md:-top-7 left-4 md:left-7 
                text-xl md:text-2xl 
